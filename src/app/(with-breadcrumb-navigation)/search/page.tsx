...
import SectionHeader from '@/app/(Main-pages)/home/components/SectionHeader';
    ...
    if (!results || !results.data || results.data.length === 0) {
        return (
            <div className="container mx-auto px-4 py-20 text-center text-gray-500">
                ...
                <img src="https://cdn3.iconfinder.com/data/icons/empty-states-3/600/searching-box-empty-not_found-error-404-512.png" alt="" className="m-auto" />
